  ...
  return (
    ...
    <>
      <Text style={styles.smallText}>
        {`Hello ${authState.user.username}, below are your entire statistics here on Zubar.`}
      </Text>
      <Text style={styles.smallText}>Keep the grind going... </Text>
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.box}>
          <Text style={styles.mediumText}>
            {!isEmpty(authState.myProfile)
              ? authState.myProfile?.comics?.length
              : 0}
          </Text>
        ...
        <View style={styles.box}>
          <Text style={styles.mediumText}>
            {!isEmpty(authState.myProfile)
              ? authState.myProfile?.musics?.length
              : 0}
          </Text>
        ...
        <View style={styles.box}>
          <Text style={styles.mediumText}>
            {!isEmpty(authState.myProfile)
              ? subtotal(authState.myProfile?.comics)
              : 0}
          </Text>
        ...
        <View style={styles.box}>
          <Text style={styles.mediumText}>
            {!isEmpty(authState.myProfile)
              ? subtotal(authState.myProfile?.musics)
              : 0}
          </Text>
