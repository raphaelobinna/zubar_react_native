    ...
    return (
        ...
        <ScrollView style={styles.container} >
            ...
            <View style={styles.article}>
                <InputText label={'Full Name'} style={InputStyle} placeholder={'Enter your full name'} returnInput={value => setInput({ ...input, full_name: value.trim().toLowerCase() })} />
            </View>

            <View style={styles.article}>
                <InputText label={'Username'} style={InputStyle} placeholder={'Enter your username'} returnInput={value => setInput({ ...input, username: value.trim().toLowerCase() })} />
            </View>
            ...
            <View style={styles.article}>
                <InputSecureText label={'Confirm Password'} style={InputStyle} placeholder={'Confirm your password'} returnInput={value => setInput({ ...input, password_confirmation: value })} />
            </View>

            <SolidRectangleButton style={ButtonStyle} disabled={disabled} title='Sign up' onPress={() => dispatch(registerUserAction({ ...input }))} />

            <Text style={styles.smallText} >Already have an account? <Text onPress={() => navigation.navigate('Login')} style={styles.boldText} >Sign-in</Text></Text>
