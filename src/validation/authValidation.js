...
export const loginUserValidation = (dispatch, payLoad) => {
  ...
  Toast.show({
    type: "errorToast",
    text1: "Error",
    text2: `${Object.values(msg)[0]}`,
  });
  //   dispatch(
  //     setActivityNotificationAction({
  //       type: "info",
...
export const registerUserValidation = (dispatch, payLoad) => {
  ...
  let rules = {
    ...
    confirmation: (value) => {
      return value.password === value.confirmPassword ? true : false;
    },
  };
  let messages = {
    email: {
...
export const changeUserPasswordValidation = (dispatch, payLoad) => {
  let data = {
    ...
    confirmation: {
      ...
      repeatPassword: payLoad.new_password_confirmation,
    },
  };
  let rules = {
    ...
    confirmation: (value) => {
      return value.newPassword === value.repeatPassword ? true : false;
    },
  };
  let messages = {
    old_password: {
